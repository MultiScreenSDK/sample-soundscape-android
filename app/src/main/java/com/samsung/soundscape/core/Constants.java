...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.samsung.soundscape";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "SoundScape";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.samsung.soundscape.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.samsung.soundscape.";
